...
namespace icFlow.Rendering
{
    public class RenderPrms
    {
        ...
        [Category("CZs")]
        [XmlIgnore]
        public Color DamagedCZColor { get; set; } = Color.FromArgb(85,152,143);
        ...
        public float TransparencyCoeff { get; set; } = 55f/255f;
        ...
        [Category("Light")]
        public bool Light2 { get; set; } = false;


        [Category("Light")]
        public float L0x { get; set; } = -0.5f;
        [Category("Light")]
        public float L0y { get; set; } = -1;
        [Category("Light")]
        public float L0z { get; set; } = 1;
        [Category("Light")]
        public float L0intensity { get; set; } = 0.6f;

        [Category("Light")]
        public float L1x { get; set; } = -0.5f;
        [Category("Light")]
        public float L1y { get; set; } = 1;
        [Category("Light")]
        public float L1z { get; set; } = 0.7f;
        [Category("Light")]
        public float L1intensity { get; set; } = 0.5f;
        ...
        [Category("Light")]
        public float L2intensity { get; set; } = 0.9f;
        #endregion
