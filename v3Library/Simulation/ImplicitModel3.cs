...
namespace icFlow
{
    public class ImplicitModel3
    {
        ...
        public void PrepareToCompute()
        {
            ...
            mc.UpdateStaticStructureData(prms.Symmetric);
...
//            else tcf0.IncrementTime(prms.InitialTimeStep);
        ...
        void _addCollidingNodesToStructure()
        {
            ...
            if (prms.CollisionScheme != ModelPrms.CollisionSchemes.None)
            {
                ...
                Parallel.ForEach(mc.activeNodes, nd => {
                    nd.allNeighbors.UnionWith(nd.adjNeighbors);
                });
            } else
            {
                // no collisions
        ...
        void _acceptFrame()
        {
            ...
            if (nFailedCZ > 0)
            {
                ...
                mc.UpdateStaticStructureData(prms.Symmetric);    // active CZ count has changed
        ...
        public void Step()
        {
            ...
            do
            {
                ...
                bcsr.CreateStructure(mc.activeNodes, tcf0);
                ...
                // solve with MKL, record time
                bcsr.Assert();
                bcsr.Solve(tcf0, prms.Symmetric);
